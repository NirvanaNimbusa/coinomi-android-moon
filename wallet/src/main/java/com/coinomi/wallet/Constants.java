...
import com.coinomi.core.coins.MooncoinMain;
...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            ...
            new CoinAddress(MooncoinMain.get(),     new ServerAddress("aux.bazco.in", 50101),
                                                    new ServerAddress("aux.bazco.in", 50101))
    );
    ...
    static {
		...
		COINS_ICONS.put(CoinID.MOONCOIN_MAIN.getCoinType(), R.drawable.mooncoin);

        COINS_BLOCK_EXPLORERS = new HashMap<CoinType, String>();
        COINS_BLOCK_EXPLORERS.put(CoinID.BITCOIN_MAIN.getCoinType(), "https://blockchain.info/tx/%s");
        COINS_BLOCK_EXPLORERS.put(CoinID.MOONCOIN_MAIN.getCoinType(), "https://chainz.cryptoid.info/moon/tx.dws?%s");
    }

    public static final CoinType DEFAULT_COIN = MooncoinMain.get();
